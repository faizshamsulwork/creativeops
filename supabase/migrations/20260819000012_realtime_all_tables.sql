-- ============================================================================
-- Copied verbatim from repo root: supabase-realtime-all-tables.sql
-- Adds the remaining tables (creative_requests, team_leaves, handover_logs, task_activity_logs, task_client_waiting_periods) to the realtime publication.
-- ============================================================================
